...
void CommandLine(int argc, char** argv) {
  ...
  AddFlag("--eta",
          ...
          float(0.02));
  AddFlag("--ot",
		  "The output times for objective function value.\n"
		  "    Default: 30",
		  int(30));
  AddFlag("--buffer_mb",
...
void OptimizeCenters(const SfDataSet& data_set,
  ...
  if (CMD_LINE_STRINGS["--opt_type"] == "batch_kmeans") {
    ...
    sofia_cluster::MiniBatchKmeans(CMD_LINE_INTS["--iterations"],
				   ...
				   CMD_LINE_FLOATS["--L1_lambda"],
				   CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_kmeans") {
    sofia_cluster::SVRGKmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           data_set,
           cluster_centers,
           CMD_LINE_FLOATS["--eta"],
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_s_kmeans") {
    sofia_cluster::SVRGSKmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           data_set,
           cluster_centers,
           CMD_LINE_FLOATS["--eta"],
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_mb_kmeans") {
    sofia_cluster::SVRGMBKmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
	         CMD_LINE_INTS["--mini_batch_size"],
           data_set,
           cluster_centers,
           ...
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_mb2_kmeans") {
    sofia_cluster::SVRGMB2Kmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           CMD_LINE_INTS["--mini_batch_size"],
           data_set,
           cluster_centers,
           ...
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_mb3_kmeans") {
    sofia_cluster::SVRGMB3Kmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           CMD_LINE_INTS["--mini_batch_size"],
           data_set,
           cluster_centers,
           ...
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_mb4_kmeans") {
    sofia_cluster::SVRGMB4Kmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           CMD_LINE_INTS["--mini_batch_size"],
           data_set,
           cluster_centers,
           ...
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "svrg_mb5_kmeans") {
    sofia_cluster::SVRGMB5Kmeans(CMD_LINE_INTS["--iterations"],
           CMD_LINE_INTS["--m"],
           CMD_LINE_INTS["--mini_batch_size"],
           data_set,
           cluster_centers,
           ...
           CMD_LINE_FLOATS["--L1_lambda"],
           CMD_LINE_FLOATS["--L1_epsilon"]);
  } else if (CMD_LINE_STRINGS["--opt_type"] == "saga_kmeans") {
    sofia_cluster::SAGAKmeans(CMD_LINE_INTS["--iterations"],
            data_set,
            cluster_centers,
            CMD_LINE_FLOATS["--eta"]);
  } else { 
...
int main (int argc, char** argv) {
  ...
  objective_output_times = CMD_LINE_INTS["--ot"];
